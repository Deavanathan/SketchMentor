...
def generate_video(problem: str, host: str = "localhost:8001", scheme: str = "http"):
    ...
    try:
        ...
        print(f"Generated code : {pipeline_result['code']}")
        ...
        quality = "480p15"  # Should match your Manim settings
        ...
        if not os.path.exists(output_file):
            ...
            # Try to locate the video file by scanning the directory
        ...
        # Construct the video URL based on the provided host and scheme
        ...
        # Fallback video in case of error
